...
export class AppointmentDialogComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.PatientPhoneContentFormControl.valueChanges.subscribe(
      (value: string) => {
    ...
    this.PatientDescriptionContentFormControl.valueChanges.subscribe(
      (value: string) => {
    ...
    this.PatientLastNameContentFormControl.valueChanges.subscribe(
      (value: string) => {
    ...
    this.PatientCategoryContentFormControl.valueChanges.subscribe(
      (value: string) => {
    ...
    this.PatientAppointmentDateContentFormControl.valueChanges.subscribe(
      (value: string) => {
        console.log("PatientCategoryContentFormControl changed:", value);
